...
var snowStorm = (function(window, document) {
  ...
  this.flakeLeftOffset = 30;       // Left margin/gutter space on edge of container (eg. browser window.) Bump up these values if seeing horizontal scrollbars.
  this.flakeRightOffset = 30;      // Right margin/gutter space on edge of container
  this.flakeWidth = 6;            // Max pixel width reserved for snow element
  this.flakeHeight = 6;           // Max pixel height reserved for snow element
